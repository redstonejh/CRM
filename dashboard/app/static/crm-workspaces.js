...
(() => {
  const MODULES = [
    ...
    { key: "money", label: "Money", api: () => window.crmMoneyRoom },
  ...
  const THEATERS = { home:["home"],desk:["desk"],people:["people"],pipeline:["pipeline"],jobs:["jobs"],money:["money-room"],planner:["planner"],assignments:["assignments"],calendar:["calendar"],cases:["tickets"] };

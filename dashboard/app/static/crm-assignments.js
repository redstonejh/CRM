...
(() => {
  ...
  function ensureStyles() {
    ...
    const style = document.createElement("style"); style.id = "crm-assignments-styles"; style.textContent = `
      ...
      .crm-assignment-pipeline{position:relative;width:max-content;height:100%;min-height:0;display:flex;align-items:flex-start;justify-content:flex-start;gap:var(--crm-object-gap,18px);padding:0 var(--crm-rail-inset);box-sizing:border-box;will-change:transform}

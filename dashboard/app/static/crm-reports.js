...
(() => {
  const REPORT_WIDGETS = [
    ...
    {
      key: "crm-report-outstanding-cash",
      layout: "builder",
      type: "stat",
      col: 1,
      row: 2,
      ...
      config: { label: "Outstanding Cash", title: "Outstanding Cash", metric: "sum", valueField: "amountValue", format: "currency" },
    },
    {
      key: "crm-report-overdue-invoices",
      layout: "builder",
      type: "stat",
      col: 2,
      row: 2,
      ...
      config: { label: "Overdue Invoices", title: "Overdue Invoices", metric: "count", format: "number" },
    },
    {
      key: "crm-report-today-hand",
      layout: "builder",
      type: "stat",
      col: 3,
      row: 2,
      ...
      rows: 1,
      data: "todayHand",
      config: { label: "Today Hand", title: "Today Hand", metric: "count", format: "number" },
    },
    {

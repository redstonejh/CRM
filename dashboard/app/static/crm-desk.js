...
(() => {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      .crm-overview-project{appearance:none;position:relative;flex:0 0 304px;height:176px;box-sizing:border-box;display:grid;grid-template-rows:auto minmax(0,1fr);gap:10px;padding:13px;text-align:left;border:1px solid rgba(255,255,255,.15);border-radius:14px;background:linear-gradient(155deg,rgba(20,31,44,.9),rgba(10,18,27,.84));-webkit-backdrop-filter:blur(14px) saturate(125%);backdrop-filter:blur(14px) saturate(125%);color:rgba(255,255,255,.75);box-shadow:inset 0 1px rgba(255,255,255,.13),0 14px 28px -20px rgba(0,0,0,.88);cursor:pointer;scroll-snap-align:start;transition:color .14s ease,border-color .14s ease,box-shadow .14s ease}
      .crm-overview-project:hover,.crm-overview-project:focus-visible{outline:0;color:#fff;border-color:rgba(157,198,250,.25)}.crm-overview-project.is-selected{color:#fff;border-color:rgba(151,196,255,.34);box-shadow:inset 0 1px rgba(255,255,255,.14),0 0 0 1px rgba(92,151,228,.07),0 18px 34px -22px rgba(30,88,166,.72)}

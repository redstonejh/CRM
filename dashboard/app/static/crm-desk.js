...
(() => {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      .crm-overview-head{display:flex;align-items:center;padding:0 20px;border-bottom:1px solid rgba(255,255,255,.09)}.crm-overview-title{font-size:.95rem;font-weight:700}
      ...
      .crm-overview-section-head{height:36px;display:flex;align-items:center;gap:12px;padding:0 3px}.crm-overview-section-title{font-size:.72rem;font-weight:680;color:rgba(255,255,255,.82);text-shadow:0 1px 8px rgba(0,0,0,.72)}
      .crm-overview-empty-inline{color:rgba(255,255,255,.3);font-size:.66rem;font-weight:600}
      ...
      .crm-overview-ticket-section,.crm-overview-recent{min-width:0;min-height:0;display:grid;grid-template-rows:36px minmax(0,1fr);background:transparent}
      .crm-overview-tickets{min-width:0;min-height:0;display:flex;align-items:center;gap:16px;overflow-x:auto;overflow-y:hidden;padding:6px 2px 16px;scrollbar-width:thin;scrollbar-color:rgba(255,255,255,.17) transparent}
